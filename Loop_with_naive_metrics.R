...
#eliminate last two rows to have full weeks only
...
while(i <= iterations){
  ...
  #add features
  new_train$date = calendar$date[1:1911]
  new_train$day = calendar$weekday[1:1911]
  new_train$week = calendar$wm_yr_wk[1:1911]
  #rename column
